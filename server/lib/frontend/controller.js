function FrontEnd(dependencies) {
	...
	const home = require(`${dependencies.root}/lib/routes/frontend/home`)(dependencies);
	const seo = require(`${dependencies.root}/lib/routes/frontend/seo`)(dependencies);
	const maintenance = require(`${dependencies.root}/lib/routes/frontend/maintenance`)(dependencies);
	...
	const buildFrontendViews = () => {
		...
		_app.set('views', `${dependencies.root}/lib/views`);
		...
		_console.success('Server', 'FrontEnd module initialized');
	}
